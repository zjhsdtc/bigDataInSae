# Django settings for moviepre project.
...
SECRET_KEY = 'v&amp;y3g+7!t4q2p+t0%&amp;@7fd6&amp;^@hr7$0xdl28qh@j(63l1j@kmi'
...
ROOT_URLCONF = 'moviepre.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'moviepre.wsgi.application'
